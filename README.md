...
<p align="left">-C#<br>-.NET Core<br>-ASP.NET Web API<br>-Entity Framework Core, Dapper<br>-MS SQL, MySQL, MongoDb, CosmosDb<br>-basic Docker knowledge<br>-basic Java(Maven and Lombok), C and Python knowledge<br>-basic HTML, CSS and JS knowledge</p>
